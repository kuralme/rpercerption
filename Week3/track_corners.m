...
% Initialize the tracker and find the points in the first frame*
...
for i = 2:size(images,1)
    ...
    % Showing tracked points on the sequences of frames*
    %out = insertMarker(cell2mat(images(i)),img_pts(validity, :),'+');
    %imshow(out);
